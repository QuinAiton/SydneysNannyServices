...
const Contact = () => {
  return (
    <div
      ...
      id="contact"
    >
      <div className="relative flex w-[70vw] flex-col justify-around space-y-10  overflow-hidden rounded-xl bg-[#fef8e4] p-10 text-white shadow-lg sm:w-[90vw] md:flex-row md:space-x-1 md:space-y-0">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="inline-flex items-center space-x-2">
              <ion-icon
                ...
                aria-label="location"
              ></ion-icon>
              <span className="text-black">Pemberton, BC, Canada</span>
            </div>
          </div>
